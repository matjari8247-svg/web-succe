/**
 * Default WooCommerce Blocks saved markup for the checkout block (editor output).
 * Update when WooCommerce Blocks changes the default inner block tree.
 */
export const WOOCOMMERCE_CHECKOUT_BLOCK_HTML = String.raw`<!-- wp:woocommerce/checkout -->
